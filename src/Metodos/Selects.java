...
public class Selects {
    ...
    private final String allFromProveedores;

    public Selects() {
        this.obtenerFecha = "SELECT date('now');";
        this.nombreDeProductos = "SELECT nombre FROM Productos";
        this.allFromProveedores = "SELECT * FROM Proveedores";
    ...
    public String getAllFromProveedores() {
        return allFromProveedores;
    }
    ...
    //SELECT STOCK PRODUCTO POR ID
    public String stockProductoPorId(int id) {
